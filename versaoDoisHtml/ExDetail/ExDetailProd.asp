...
if RstExames.eof = false then
   ...
   response.write " <h1>Resultado dos exames veterinários</h1>"
   ...
   iF RstExames.eof = false then
      ...
      Do Until RstExames.eof = true
         ...
         response.write "<div class=exameSelect><img src=../scr/images/Frasco.png ><a href=PrintExamNewONLINE.asp?CodCli=" & RstCadastro("codcli") & "&text=|"& RstExames("CodExameConsulta") &"| target=_self> "& DataBr & " - " & RstExames("Nomexame") &"</a></div>"
      RstExames.movenext
      loop
   end if
