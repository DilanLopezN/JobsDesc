...
response.write "<div class=section-2><form action=CentralTeste.asp method=Get>"
response.write "<div class=titleContent><h1>Central de exames</h1> <strong>Preencha os dados de acordo com o infomado no Hospital</strong></div>"
...
response.write "<button  type=submit name=submit >Entrar</button></div>"
