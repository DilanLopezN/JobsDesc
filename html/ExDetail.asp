...
if RstExames.eof = false then
   ...
   response.write "<td width=100 bgcolor=#f9f9f9><a href=AnimalInterface.asp?id="&id&"&origem="&origem&"&CC="&RstCadastro("codcli")&"><b>Voltar � lista.</a></td></tr>"
   response.write "</table></div>"

   response.write "<div id=layer1><table width=780 class=style9 border=0>"
   response.write "<tr><td colspan=2 div align=center><hr><B>Resultado de exames veterin�rios.</b></td></tr>"
